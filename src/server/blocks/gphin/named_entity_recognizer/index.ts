...
const image =
  "northamerica-northeast1-docker.pkg.dev/phx-lucbeliveau/gphin/named_entity_recognizer";

const nlpImage =
  "northamerica-northeast1-docker.pkg.dev/phx-lucbeliveau/gphin/stanford_corenlp";
            ...
            steps: [
              {
                named_entity_recognizer: {
                  ...
                  worker: {
                    ...
                    std_ners:
                      "CAUSE_OF_DEATH,CITY,COUNTRY,CRIMINAL_CHARGE,DATE,DURATION,EMAIL,HANDLE,IDEOLOGY,LOCATION,MISC,MONEY,NATIONALITY,NUMBER,ORDINAL,ORGANIZATION,PERCENT,PERSON,RELIGION,SET,STATE_OR_PROVINCE,TIME,TITLE,URL",
                  },
                  producer: {
                    broker_host,
                    broker_port,
      ...
      containers: [
        {
          ...
          image: nlpImage,
          ports: [{ name: "nlp", containerPort: 9000 }],
        },
        {
          image,
          volumes: [
