...
const image =
  "northamerica-northeast1-docker.pkg.dev/phx-lucbeliveau/gphin/topic_classifier";
            ...
            steps: [
              {
                topic_classifier: {
                  ...
                  worker: {
                    ...
                    labels:
                      "accident,bioterrorism,contaminated foods,contaminated water,disease outbreaks,exposure to chemicals,infectious diseases,natural disasters,radioactive agents,safety of products,safety of drugs,safety of medical devices",
                    max_length: 1024,
                    threshold: 0.85,
                  },
                  producer: {
